const essaysDatabase = [
    {
        ...
        repertoire: "Ciclo do ouro",
        thesis: "Políticas públicas ineficazes e as falhas educacionais",
        arguments: "Sociólogo Émile Durkheim, uma sociedade sem regras claras, sem valores e sem limites encontra-se em estado de anomia social / filósofo Immanuel Kant, 'o homem é aquilo que a educação faz dele'",
        intervention: "O Governo Federal deve ampliar as políticas públicas existentes junto com o Governo Estadual e o Governo Municipal, ele também deve corrigir as falhas educacionais por meio da Mídia",
        connectors: "Diante do cenário exposto, ademais, nesse sentido, na medida em que, com base nisso"
    },
    {
        title: "Desafios para a valorização da herança africana no Brasil",
        ...
        repertoire: "Livro 'Nós matamos o cão tinhoso' de Luís Bernardo Honwana",
        thesis: "Papel do Estado no setor escolar e cultural",
        arguments: "Filósofo Ailton Krenak afirma que, no Brasil, existem dois grupos — a humanidade, formada pela elite econômica, e a subumanidade, a qual tem seus direitos negados / filósofa brasileira Marilena Chaui defende a ideia de que, enquanto os animais são seres naturais, os humanos são culturais",
        intervention: "Estado junto com o Ministério da Economia (ME) e o Ministério da Educação e da Cultura (MEC), desenvolver manifestações culturais. Assim como investir financeiramente na promoção de artistas e escritores",
        connectors: "Em um primeiro momento, para fundamentar essa ideia, sob outra ótica, para isso, em suma"
    },
    {
        title: "Desafios para a valorização da herança africana no Brasil",
        ...
        repertoire: "Obra literária 'Raízes do Brasil' de Sérgio Buarque de Holanda",
        thesis: "Herança dos povos africanos não é devidamente valorizada, visto que suas contribuições culturais são omitidas no meio social",
        arguments: "Lei Áurea de 1888 / Político Nelson Mandela ressalta o valor da educação e o seu potencial de salvar a humanidade",
        intervention: "Ministério da Cultura deve incentivar a exposição da cultura mediante eventos culturais, Ministério da Educação deve inserir a cultura na grade curricular",
        connectors: "Diante desse panorama, nesse viés, em virtude da, sendo assim, outrossim"
    },
    {
        title: "Desafios para a valorização da herança africana no Brasil",
        ...
        repertoire: "Álbum musical 'Duas Cidades' da banda brasileira Baiana System",
        thesis: "Falta de política pública de ensino e à ausência de lei específica",
        arguments: "Macaé Evaristo, ministra dos Direitos Humanos, é urgente a necessidade de iniciativas para a inclusão da história e da cultura afro-brasileira nas escolas / Duda Salabert, deputada federal e professora de literatura, é imprescindível a alteração da lei que orienta a educação básica brasileira",
        intervention: "Poder Executivo Federal, por meio do aumento de ações governamentais, deve estimular iniciativas educacionais, Poder Legislativo Federal, por intermédio da criação de um projeto de lei, necessita elaborar uma nova política nacional de ensino, com a obrigatoriedade de investimento público na área, com a definição de medidas de gestão pública capazes de instituir aulas multidisciplinares",
        connectors: "A princípio, para entender melhor tal posicionamento, dessa forma, portanto, dessa maneira"
    },
    {
        title: "Desafios para a valorização da herança africana no Brasil",
        ...
        repertoire: "Obra literária 'Torto Arado' de Itamar Vieira",
        thesis: "Mentalidade colonial eurocêntrica, bem como da lacuna educacional no tocante ao resgate da cultura afro-brasileira",
        arguments: "Conceito de 'racismo estrutural', cunhado pelo antropólogo Silvio Almeida / Lei de Diretrizes e Base, escritor Machado de Assis, advogado Luiz Gama",
        intervention: "Governo Federal, em parceria com as secretarias estaduais de educação, deve ampliar as campanhas de valorização / Ministério da Educação, como responsável pela elaboração de políticas públicas de educação, fomentar palestras socioeducativas",
        connectors: "Dado o exposto, Além disso, tal questão, ainda, essa problemática"
    },
    {
        title: "Desafios para a valorização da herança africana no Brasil",
        ...
        repertoire: "Filme 'Pantera Negra'",
        thesis: "Analisar o descaso da esfera educacional e a mentalidade social",
        arguments: "Estado 'zumbi', conforme o sociólogo Zygmunt Bauman / resquícios do passado colonial e imperial do país",
        intervention: "Ministério da Educação — órgão encarregado do ensino brasileiro — execute a melhoria do lecionamento sobre. Ministério das Comunicações, mediante propagandas periódicas nos veículos midiáticos, elucidar o povo sobre a temática e desconstruir mentalidades preconceituosas",
        connectors: "De início, de fato, isso ocorre pois/porque, evidentemente, ademais"
    }
];

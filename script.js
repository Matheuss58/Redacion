const essaysDatabase = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "Sociólogo Émile Durkheim (anomia social) e filósofo Immanuel Kant (importância da educação)"
            },
            {
                question: "Qual a proposta de intervenção apresentada?",
                answer: "Governo Federal deve ampliar políticas públicas e corrigir falhas educacionais"
            },
            {
    ...
    },
    {
        ...
        questions: [
            {
                question: "Qual o repertório sociocultural utilizado na introdução?",
                answer: "Livro 'Nós matamos o cão tinhoso' de Luís Bernardo Honwana"
            },
            {
                question: "Qual é a tese central da redação?",
                answer: "Papel do Estado no setor escolar e cultural"
            },
            {
                question: "Quais pensadores foram citados como argumentos?",
                answer: "Ailton Krenak (humanidade e subumanidade) e Marilena Chaui (seres culturais)"
            },
            {
                question: "Como a proposta de intervenção sugere resolver o problema?",
                answer: "Estado deve desenvolver manifestações culturais e apoiar artistas afro-brasileiros"
            },
            {
                question: "Identifique alguns conectivos utilizados no texto:",
    ...
    },
    {
        ...
        questions: [
            {
                question: "Qual obra literária foi citada na introdução?",
                answer: "'Raízes do Brasil' de Sérgio Buarque de Holanda"
            },
            {
                question: "Quais são os dois principais desafios apontados?",
                answer: "Estagnação estatal e negligência educacional"
            },
            {
                question: "Que fatos históricos foram mencionados como argumentos?",
                answer: "Lei Áurea de 1888 e citação de Nelson Mandela sobre educação"
            },
            {
                question: "Quais órgãos são sugeridos na proposta de intervenção?",
                answer: "Ministério da Cultura e Ministério da Educação"
            },
            {
                question: "Quais conectivos articulam as ideias do texto?",
    ...
    },
    {
        ...
        questions: [
            {
                question: "Qual referência cultural foi utilizada na introdução?",
                answer: "Álbum musical 'Duas Cidades' da banda Baiana System"
            },
            {
                question: "Quais são as causas apontadas para o problema?",
                answer: "Falta de política pública de ensino e ausência de lei específica"
            },
            {
                question: "Quais autoridades foram citadas como argumentos?",
                answer: "Macaé Evaristo (Ministra dos Direitos Humanos) e Duda Salabert (Deputada Federal)"
            },
            {
                question: "Como a proposta de intervenção sugere resolver o problema?",
                answer: "Ações do Poder Executivo e Legislativo para criar políticas educacionais"
            },
            {
                question: "Quais conectivos organizam o texto?",
    ...
    },
    {
        ...
        questions: [
            {
                question: "Qual obra literária foi mencionada na introdução?",
                answer: "'Torto Arado' de Itamar Vieira"
            },
            {
                question: "Quais são as causas principais do problema identificadas?",
                answer: "Mentalidade colonial eurocêntrica e lacuna educacional"
            },
            {
                question: "Que conceito sociológico foi utilizado como argumento?",
                answer: "Racismo estrutural (Silvio Almeida)"
            },
            {
                question: "Quais ações são propostas na intervenção?",
                answer: "Campanhas de valorização e palestras socioeducativas"
            },
            {
                question: "Quais conectivos foram utilizados no desenvolvimento?",
    ...
    },
    {
        ...
        questions: [
            {
                question: "Qual referência cinematográfica foi utilizada?",
                answer: "Filme 'Pantera Negra'"
            },
            {
                question: "Quais são os dois eixos de análise propostos?",
                answer: "Descaso da esfera educacional e mentalidade social"
            },
            {
                question: "Que teórico foi citado como argumento?",
                answer: "Zygmunt Bauman (estado 'zumbi')"
            },
            {
                question: "Quais ministérios são sugeridos na intervenção?",
                answer: "Ministério da Educação e Ministério das Comunicações"
            },
            {
                question: "Quais conectivos articulam o texto?",

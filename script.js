const essaysDatabase = [
    {
        ...
        questions: [
            {
                question: "Qual o repertório inicial utilizado na redação?",
                answer: "Ciclo do ouro"
            },
            {
                question: "Qual a tese apresentada na redação?",
                answer: "Políticas públicas ineficazes e as falhas educacionais"
            },
            {
                question: "Quais argumentos foram utilizados para sustentar a tese?",
                answer: "Sociólogo Émile Durkheim, uma sociedade sem regras claras, sem valores e sem limites encontra-se em estado de anomia social / filósofo Immanuel Kant, 'o homem é aquilo que a educação faz dele'"
            },
            {
                question: "Qual a proposta de intervenção apresentada?",
                answer: "O Governo Federal deve ampliar as políticas públicas existentes junto com o Governo Estadual e o Governo Municipal, ele também deve corrigir as falhas educacionais por meio da Mídia"
            },
            {
                question: "Quais conectivos foram utilizados para articular as ideias?",
                answer: "Diante do cenário exposto, ademais, nesse sentido, na medida em que, com base nisso"
            }
        ]
    },
    {
